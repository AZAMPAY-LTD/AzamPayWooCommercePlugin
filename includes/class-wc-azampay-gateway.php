...
class WC_AzamPay_Gateway extends WC_Payment_Gateway {
    ...
    public function admin_options() {
        ...
        if ($this->is_valid_for_use()) {
            ...
            <table class="form-table">
                ...
                <div class="inline error">
                    <p><strong><?php _e('AzamPay Payment Gateway Disabled', 'azampay-woo'); ?></strong>: <?php
        ...
        public function admin_scripts() {
            ...
            $azampay_admin_params = array(
                'id' => $this->id,
                'kycUrl' => plugins_url('assets/docs/Plugin_KYCs.pdf', __FILE__)
            );
            ...
            if (!$this->token_result['success']) {
                ...
                foreach ($this->partners_result['partners'] as $partner) {
                    ...
                    if ($partner_name === "Azampesa") {
                        ...
                        $logo_path = '/assets/images/' . esc_attr(strtolower($partner_name)) . '-logo.svg';
                        $other_fields .= '<label>
